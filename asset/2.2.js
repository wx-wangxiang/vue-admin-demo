...
/***/ function(module, exports, __webpack_require__) {
	...
	// 									</td>
	// 									<td>
	// 										<button :disabled="$index === 0" @click="removePrice(price)" type="button" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-remove"></i>删除</button>
	// 									</td>
	// 								</tr>
	// 							</tbody>
	// 						</table>
